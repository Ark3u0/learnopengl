...
int main() {
    ...
    Shader ourShader("/Users/sgarcia/Code/C++/opengl/transformations/exercises/ex1/shader.vs", "/Users/sgarcia/Code/C++/opengl/transformations/exercises/ex1/shader.frag");
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        // Translate and rotate texture over time
        glm::mat4 trans;
