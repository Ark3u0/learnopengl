...
int main() {
    ...
    Shader ourShader("/Users/sgarcia/Code/C++/opengl/transformations/exercises/ex2/shader.vs", "/Users/sgarcia/Code/C++/opengl/transformations/exercises/ex2/shader.frag");
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        // Container 1
        // Translate and rotate container 1 over time
        ...
        glUniformMatrix4fv(glGetUniformLocation(ourShader.Program, "transform"), 1, GL_FALSE, glm::value_ptr(transRotate));
        glBindVertexArray(vertexArrayObject);
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);
        
        // Container 2
        // Translate and scale container 2 over time
        glm::mat4 transScale;
        transScale = glm::translate(transScale, glm::vec3(-0.5f, 0.5f, 0.0f));
        GLfloat scaleFactor = glm::sin(glfwGetTime() * glm::radians(50.0f));
        transScale = glm::scale(transScale, glm::vec3(scaleFactor, scaleFactor, 0.0f));
        
        glUniformMatrix4fv(glGetUniformLocation(ourShader.Program, "transform"), 1, GL_FALSE, glm::value_ptr(transScale));
